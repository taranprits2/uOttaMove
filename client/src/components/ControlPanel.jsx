            ...
            <div className="input-group">
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                    <div className="input" style={{
                        ...
                        {start ? `${start.lat.toFixed(4)}, ${start.lon.toFixed(4)}` : "Click on map..."}
                    </div>
                    <button
            ...
            <div className="input-group">
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                    <div className="input" style={{
                        ...
                        {end ? `${end.lat.toFixed(4)}, ${end.lon.toFixed(4)}` : "Click on map..."}
                    </div>
                    <button
            ...
            {routeInfo && (
                <div style={{ marginTop: '20px', padding: '16px', borderRadius: '8px', background: '#ecfdf5', border: '1px solid #10b981' }}>
                    ...
                    <div style={{ fontSize: '0.875rem', color: '#047857' }}>
                        Distance: {routeInfo.distance_km?.toFixed(2)} km
                    </div>
                    <div style={{ fontSize: '0.875rem', color: '#047857' }}>
                        Accessible: {routeInfo.accessibility_percent}%
                    </div>
